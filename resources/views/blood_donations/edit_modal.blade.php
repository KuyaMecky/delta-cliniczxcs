            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        {{ Form::select('blood_donor_id', $donorName, null, ['class' => 'form-select', 'required', 'id' => 'editDonationDonorName', 'data-control' => 'select2', 'required']) }}
                    </div>
                    <div class="form-group col-sm-12">
                        {{ Form::label('bags', __('messages.blood_donation.bags').(':'),['class' => 'form-label']) }}
                        <span class="required"></span>
                        {{ Form::number('bags', '', ['id'=>'editDonationBags','class' => 'form-control','required','min' => 1, 'max' => 100]) }}
                    </div>
                </div>
            </div>
