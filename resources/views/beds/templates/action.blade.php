<a href="javascript:void(0)" title="<?php echo __('messages.common.edit') ?>" class="btn btn-icon btn-bg-light bed-edit-btn btn-active-color-primary btn-sm me-1" data-id="{{$row->id}}">
...
<a href="javascript:void(0)" title="<?php echo __('messages.common.delete') ?>" data-id={{$row->id}} class="bed-delete-btn btn btn-icon btn-bg-light btn-active-color-danger btn-sm">
<span class="svg-icon svg-icon-3">
