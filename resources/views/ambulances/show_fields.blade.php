<div>
    <div class="tab-content" id="myAmbulanceTabContent">
        <div class="tab-pane fade show active" id="ambulancePoverview" role="tabpanel">
                    ...
                    <div class="card-body  border-top p-9">
                        <div class="row mb-7">
                            ...
                            <div class="col-lg-3 d-flex flex-column">
                                ...
                                <span class="fw-bolder fs-6 text-gray-800" data-placement="top"  data-bs-original-title="{{ date('jS M, Y', strtotime($ambulance->created_at)) }}">{{ $ambulance->created_at->diffForHumans() }}</span>
                            </div>
                            <div class="col-lg-3 d-flex flex-column">
                                <label class="fw-bold text-muted py-3">{{ __('messages.common.last_updated').(':')  }}</label>
                                <span class="fw-bolder fs-6 text-gray-800" data-placement="top"  data-bs-original-title="{{ date('jS M, Y', strtotime($ambulance->updated_at)) }}">{{ $ambulance->updated_at->diffForHumans() }}</span>
                            </div>
                        </div>
                    </div>
                </div>
