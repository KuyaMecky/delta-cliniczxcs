<div>
    <div class="tab-content" id="myTabContent">
        <div class="tab-pane fade show active" id="paymentOverview" role="tabpanel">
                    ...
                    <div class="card-body  border-top p-9">
                        <div class="row mb-7">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-2 d-flex flex-column">
                                ...
                                <span class="fw-bolder fs-6 text-gray-800">{{ \Carbon\Carbon::parse($payment->payment_date)->translatedFormat('jS M, Y')}}</span>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-2 d-flex flex-column">
