        ...
        <div class="dropdown-menu py-0" aria-labelledby="patientsPrescriptionFilterBtn">
            ...
            <div class="p-5">
                <div class="mb-10">
                    ...
                    {{ Form::select('status', collect($filterHeads[0])->sortBy('key')->reverse()->toArray(),null, ['id' => 'patients_prescription_filter_status', 'data-control' =>'select2', 'class' => 'form-select role-selector']) }}
                </div>
