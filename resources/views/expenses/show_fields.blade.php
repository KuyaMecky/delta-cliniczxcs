<div>
    <div class="tab-content" id="myTabContent">
        <div class="tab-pane fade show active" id="expenseOverview" role="tabpanel">
                    ...
                    <div class="card-body  border-top p-9">
                        <div class="row mb-7">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-2 d-flex flex-column">
                                ...
                                <p class="m-0">
                                    <span class="badge bg-light-info fs-6">{{!empty($expenses->invoice_number)?$expenses->invoice_number:'N/A'}}</span>
                                </p>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-2 d-flex flex-column">
