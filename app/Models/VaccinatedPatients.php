...
class VaccinatedPatients extends Model
{
     ...
     * @return array
     */
    function prepareVaccinationData(): array
    {
        return [
            'id'            => $this->id,
            'vaccine_name'  => $this->vaccination->name,
            'dose_number'   => $this->dose_number,
            'date'          => isset($this->dose_given_date) ? Carbon::parse($this->dose_given_date)->format('d F y') : '',
            'time'          => isset($this->dose_given_date) ? \Carbon\Carbon::parse($this->dose_given_date)->isoFormat('LT') : '',
            'serial_number' => $this->vaccination_serial_number,
        ];
    }
