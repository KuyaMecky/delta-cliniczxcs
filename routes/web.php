...
Route::group(['middleware' => ['auth', 'verified', 'xss', 'checkUserStatus']], function () {
    ...
    Route::group(['middleware' => ['role:Admin|Patient|Doctor|Receptionist|Nurse|Secretary|MedTech|Pharmacist|Case Manager']],
        function () {
    ...
    Route::group(['middleware' => ['role:Admin|Doctor|Receptionist|Nurse|Secretary|MedTech|Pharmacist|Case Manager']],
        function () {
            Route::group(['prefix' => 'employee', 'namespace' => 'Employee'], function () {
    ...
    // excel export routes.
    Route::group(['middleware' => ['role:Receptionist|MedTech']], function () {
    ...
    Route::group(['middleware' => ['role:Admin|Patient|Doctor|Receptionist|Nurse|Case Manager|Secretary']],
        function () {
    ...
    Route::group(['middleware' => ['role:Admin|Doctor|Receptionist|Secretary']], function () {
        Route::get('doctors/{doctor}', 'DoctorController@show')->where('doctor', '[0-9]+')->name('doctors_show');
    });

    Route::group(['middleware' => ['role:Admin|Patient|Doctor|Receptionist|Nurse|Secretary']], function () {
    ...
    Route::group(['middleware' => ['role:Admin|Receptionist|Patient|Secretary']], function () {
    ...
    Route::group(['middleware' => ['role:Admin|Doctor|MedTech|Pharmacist|Case Manager|Secretary|Receptionist']],
        function () {
            Route::group(['prefix' => 'employee', 'namespace' => 'Employee'], function () {
    ...
    Route::group(['middleware' => ['role:Admin|MedTech|Pharmacist']], function () {
    ...
    Route::group(['middleware' => ['role:Admin|Doctor|Case Manager|Patient|Receptionist|Secretary']], function () {
    ...
    Route::group(['middleware' => ['role:Admin|Doctor|Case Manager|Receptionist|Secretary']], function () {
        Route::get('patient-admissions/{patient_admission}', 'PatientAdmissionController@show')
    ...
    Route::group(['middleware' => ['role:Admin|Secretary|Doctor|Nurse|Receptionist|MedTech|Pharmacist|Case Manager']],
        function () {
    ...
    Route::group(['middleware' => ['role:Admin|Secretary|Receptionist']], function () {
    ...
    Route::group(['middleware' => ['role:Admin|Receptionist|Case Manager|Doctor|Secretary|Pharmacist']], function () {
        //Sms Rout
    ...
    Route::group(['middleware' => ['role:Admin|Receptionist|MedTech|Pharmacist']], function () {
    ...
    Route::group(['middleware' => ['role:Admin|MedTech']], function () {
...
//        Route::get('export-ambulances', 'AmbulanceController@ambulanceExport')->name('ambulance.excel');
    ...
    Route::group(['middleware' => ['role:Admin|Doctor|Receptionist|MedTech']], function () {
    ...
    Route::group(['middleware' => ['role:Admin|Patient|Doctor|Receptionist|Secretary|Case Manager|Nurse']],
        function () {
